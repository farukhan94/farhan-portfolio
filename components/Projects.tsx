        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center px-6">
            <motion.div
              ...
              className={`absolute inset-0 bg-black/80 ${isMobile ? 'backdrop-blur-sm' : 'backdrop-blur-xl'}`}
            ></motion.div>
            ...
            <motion.div
              ...
              className="relative glass w-full max-w-4xl max-h-[90vh] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl flex flex-col will-animate"
              role="dialog"
            ...
            >
              ...
              <div className="p-8 md:p-12 border-b border-white/5 flex justify-between items-start bg-gray-900/50">
                <div>
                  ...
                  <h2 id="modal-title" className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter">
